...
var wrapStyle = {
  ...
  boxShadow: '0 -4px 16px rgba(102,49,48,0.1)',
}
...
export default function StickyBooking() {
  ...
  return (
    <div style={wrapStyle}>
      <a href={WA_LINK} target="_blank" rel="noreferrer" style={btnStyle}>
